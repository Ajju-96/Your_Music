console.log("Now I am going to write the js code");
...
const palyMusic = (track, pause = false) => {
  // let audio = new Audio("/gaana/" + track)
...
async function displayAlbums(){
  let a = await fetch(`http://127.0.0.1:5500/gaana/`);
  let response = await a.text();
  //   console.log(response);
  let div = document.createElement("div");
  div.innerHTML = response;
...
//--------
  ...
  // Attach an event listen to play previos, next
  ...
  // Add an event listener to previos
